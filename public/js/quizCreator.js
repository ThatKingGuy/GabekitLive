...
function addQuestion(){
    ...
    newQuestionDiv.setAttribute('class', "question-field bg-gradient-to-r bg-gradient-to-r from-orange-500 to-yellow-500 max-w-screen-lg  shadow-2xl rounded-lg mx-auto text-center py-12 mt-4");
...
function deleteQuestion(){
    if(questionNum > 1){
        var q = document.getElementById('question-field'+questionNum);
        q.remove();
        questionNum--;
    }
}
